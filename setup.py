...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    check_if_rocm_home_none("fast_hadamard_transform")
    ...
    cuda_sources=[
        "csrc/fast_hadamard_transform.cu",
        "csrc/fast_hadamard_transform_cuda.cu",
    ]
...
def get_wheel_url():
    ...
    if IS_ROCM:
        ...
        wheel_filename = f"{PACKAGE_NAME}-{fast_hadamard_transform_version}+rocm{hip_version}torch{torch_version}cxx11abi{cxx11_abi}-{python_version}-{python_version}-{platform_name}.whl"
    else:
